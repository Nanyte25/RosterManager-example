...
var MembersViewItems = function(cursor) {
	...
	if(!searchString || searchString == "") {
		...
		var searchFields = ["name", "phone", "email", "note", "active"];
...
Template.MembersView.events({
	...
	"click #dataview-export-default": function(e, t) {
		e.preventDefault();
		MembersViewExport(this.members, "csv");
	},
	...
	"click #dataview-export-tsv": function(e, t) {
		e.preventDefault();
		MembersViewExport(this.members, "tsv");
	},

	"click #dataview-export-json": function(e, t) {
		e.preventDefault();
		MembersViewExport(this.members, "json");
	}
...
Template.MembersView.helpers({
	...
	"isNotFound": function() {
		return this.members && pageSession.get("MembersViewSearchString") && MembersViewItems(this.members).length == 0;
	},
...
Template.MembersViewTable.helpers({
	"tableItems": function() {
		return MembersViewItems(this.members);
	}
});
